...
export const BOND_LINES: Record<string, BondLine[]> = {
  pappy: [
    ...
    { minBond: 50, line: "When I go, the plot stays with the hollow. Not a bloodline, a promise. You're the promise now." },
  ],
  stoic: [
    ...
    { minBond: 50, line: "I've stopped counting your trades. I just know they land." },
  ],
  nettie: [
    ...
    { minBond: 50, line: "I'll tell you a hatter's secret: I make one hat a year I never sell. This year's is yours." },
  ],
  bramble: [
    ...
    { minBond: 50, line: "The south bank is yours if you ever want a quiet plot. I won't tell anyone." },
  ],
  greg: [
    ...
    { minBond: 50, line: "The watch is a job. What you do is a calling. I said it, so it's true." },
  ],
  brine: [
    ...
    { minBond: 50, line: "When I'm gone, that ledger is yours. Every name in it but one. That one's fine where it is." },
  ],
  wim: [
    ...
    { minBond: 50, line: "The third hull. I said don't make it a thing. Make it a thing." },
  ],
  pipkin: [
    ...
    { minBond: 50, line: "Cluckers follows you now. I don't mind. She knows a farmer when she sees one." },
  ],
  miller: [
    ...
    { minBond: 50, line: "Stop by before I open sometime. The first loaf is always for one gnome, and I want it to be you." },
  ],
};
