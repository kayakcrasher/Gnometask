...
export const QUEST_POOL: QuestDef[] = [
  {
    ...
    giver: "pappy",
    offer: "You stepped off on my dock. Good. I'm Ol Pappy. Before the cottage, the woods. Chop a tree and bring the log back here.",
  ...
  },
  {
    ...
    giver: "pappy",
    offer: "Town's up the path from this dock. Buy a palisade, a lamp, a bench — anything that says gnomefolk live here. Then come tell me. I don't move.",
