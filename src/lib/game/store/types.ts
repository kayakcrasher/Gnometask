...
export type GameState = GameSave &
  GameUi & {
    ...
    plantSapling: (treeId: string) => void;
    sellLogs: () => void;
    ...
    sellGood: (id: string) => void;
    buyAnimal: (kind: "cows" | "goats" | "sheep") => void;
    upgradeCoop: () => void;
    tendHerd: (job: "milk" | "eggs" | "wool") => void;
    sellCalf: () => void;
    fundExpedition: (stake: number) => void;
    collectExpedition: () => void;
    travelIsle: (id: "reed" | "salt" | "holm") => void;
    liftFence: (slotId: string) => void;
    sailChart: () => void;
    leaveIsle: () => void;
    startIsleFight: (which: "chief" | number) => void;
    claimTile: (id: string) => void;
    buyParcel: (id: string) => void;
    ...
    sootheDragon: () => void;
    tickWorld: () => void;
    enterCourt: (town: import("../data/civic").CivicTown) => void;
    advanceCase: () => void;
    enterPub: (town: import("../data/civic").CivicTown) => void;
    buyPint: (beerId: string) => void;
